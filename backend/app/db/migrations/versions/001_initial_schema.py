...
def upgrade() -> None:
    user_role_enum = sa.Enum("admin", "investigator", "viewer", name="userrole")
    user_role_enum.create(op.get_bind(), checkfirst=True)

    case_status_enum = sa.Enum("open", "in_progress", "closed", name="casestatus")
    case_status_enum.create(op.get_bind(), checkfirst=True)

    artifact_status_enum = sa.Enum("queued", "parsing", "parsed", "parse_failed", name="artifactstatus")
